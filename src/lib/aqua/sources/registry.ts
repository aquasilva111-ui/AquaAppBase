 ...
 * button that only simulates success. AT Protocol is read-only here until
 * real OAuth lands; ActivityPub/Web stay off until implemented.
 */
export const SOURCE_CAPABILITIES: Record<ContentOrigin, SourceCapabilities> = {
  ...
  ACTIVITYPUB: { read: false, reply: false, like: false, repost: false, follow: false, publish: false },
